    ...
    <main className="min-h-screen pb-20">
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          >
            <span className="flex items-center gap-1.5">&#x1F468;&#x200D;&#x1F373; 레시피모아<span className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-[9px] font-bold px-1.5 py-0.5 rounded shadow-sm tracking-wider">GPT</span></span>
          </button>
